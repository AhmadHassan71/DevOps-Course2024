...
<div align="left">
  <h3>📚 Chameleon - Language Exchange Platform</h3>
  <p>
    🚀 <strong>Role:</strong> Team Leader<br>
    🛠️ <strong>Technologies:</strong> MERN Stack, Docker, Coolify<br>
    🌟 <strong>Highlights:</strong>
    <ul>
      <li>Developed a platform connecting users globally based on shared interests and language preferences.</li>
      <li>Integrated features like Voice/Video Calls, Ranking System, and Language-based Hubs.</li>
      <li>Ensured smooth deployment using Docker and Coolify.</li>
    </ul>
    🔗 <strong>Impact:</strong> Revolutionized global language learning and cultural exchange.
  </p>
</div>
...
<div align="left">
  ...
  <p>
    ...
    <ul>
      ...
      <li>Added features like Spending Visualization, Goal Setting, and Stock Data Visualization.</li>
      <li>Designed user-friendly interfaces for financial planning and tracking.</li>
    </ul>
    🔗 <strong>Impact:</strong> Simplified financial management for users, empowering them to make smarter financial decisions.
  </p>
</div>

<div align="left">
  <h3>🌐 Customer Outreach Portal - Atlas Foods</h3>
  <p>
    🚀 <strong>Role:</strong> Software Engineering Intern<br>
    🛠️ <strong>Technologies:</strong> React, Django<br>
    🌟 <strong>Highlights:</strong>
    <ul>
      <li>Created an interactive customer outreach platform to enhance client engagement.</li>
      <li>Streamlined data handling for efficient customer management.</li>
    </ul>
    🔗 <strong>Impact:</strong> Boosted client interactions and operational efficiency for Atlas Foods.
  </p>
</div>

<div align="left">
  <h3>🎤 Urdu Audio Transcription System</h3>
  <p>
    🚀 <strong>Role:</strong> Software Engineering Intern<br>
    🛠️ <strong>Technologies:</strong> Python, Machine Learning Libraries<br>
    🌟 <strong>Highlights:</strong>
    <ul>
      <li>Designed a Machine Learning solution for high-accuracy Urdu speech-to-text transcription.</li>
      <li>Enabled better accessibility for the Urdu-speaking community.</li>
    </ul>
    🔗 <strong>Impact:</strong> Pioneered advancements in Urdu accessibility tools for media and education.
  </p>
</div>
